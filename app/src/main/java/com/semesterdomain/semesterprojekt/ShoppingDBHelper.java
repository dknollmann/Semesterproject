...
public class ShoppingDBHelper extends SQLiteOpenHelper {
    ...
    public ArrayList<Product> getAllProductsOfList(ShoppingList list) {
        open_database();
    ...
    public ArrayList<ShoppingList> getShoppingListsByUser(User user) {
        ...
        ArrayList<ShoppingList> listArr = new ArrayList<>();
    ...
    public boolean deleteList(User user, ShoppingList clicked_list) {
        open_database();

        ShoppingList list = getListById(clicked_list.getList_id());
