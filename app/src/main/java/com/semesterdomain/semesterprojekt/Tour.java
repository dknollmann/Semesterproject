...
public class Tour{
    ...
    public Tour(){
        for (int i = 0; i < TourManager.numberOfProducts(); i++) {
            tour.add(null);
        }
    }

    public Tour(ArrayList<Product> tour){
    ...
    public void generateIndividual() {
        ...
        for (int productIndex = 0; productIndex < TourManager.numberOfProducts(); productIndex++) {
            setProduct(productIndex, TourManager.getProduct(productIndex));
        }
